export const Product = [
  ...
  { 
    ...
    sizes: ["15kg (Womens)", "20kg (Mens)"] 
  },
  { id: 2, name: "Power Rack", category: "Strength", price: "$699", rating: 4.8, image: "bg-gradient-to-br from-zinc-700 to-black" }, // One size
  { 
    id: 3, 
    name: "Pro Kettlebell", 
    category: "Strength", 
    ...
    sizes: ["4kg", "8kg", "12kg", "16kg", "20kg", "24kg", "32kg"] // Added KG options
  },
  ...
  { 
    ...
    sizes: ["5lb", "10lb", "15lb", "25lb", "35lb", "50lb"] // Specific weights
  },
  ...
  { 
    ...
    sizes: ["5kg", "10kg", "15kg", "20kg", "25kg"] // Added KG options
  },
  ...
  { 
    ...
    sizes: ["3kg", "5kg", "7kg", "9kg", "12kg"] // Added KG options
  },
  { 
    id: 16, 
    name: "Battle Ropes", 
    ...
    sizes: ["30ft (1.5\")", "40ft (1.5\")", "50ft (2.0\")"] // Length + Thickness
  }, 
  { 
    id: 17, 
    ...
    sizes: ["10kg Plate", "15kg Plate", "20kg Plate"] // Plate weight options
  }, 
  ...
  { 
    ...
    sizes: ["10kg", "20kg", "30kg", "40kg", "50kg"] // KG Capacity
  }, 
  { 
    id: 25, 
    ...
    sizes: ["100lb", "150lb", "200lb", "250lb", "300lb"] 
  }, 
  ...
  { 
    ...
    sizes: ["12 Inch", "18 Inch", "24 Inch", "30 Inch"] // Height options
  },
  ...
  { id: 51, name: "Yoga Mat Pro", category: "Accessories", price: "$45", rating: 4.6, image: "bg-gradient-to-br from-teal-400 to-teal-600", sizes: ["3mm", "5mm", "8mm"] }, // Thickness
  { 
    id: 52, 
    ...
    sizes: ["X-Light (5lb)", "Light (15lb)", "Medium (30lb)", "Heavy (50lb)"] 
  }, 
  { id: 53, name: "Lifting Belt", category: "Accessories", price: "$50", rating: 4.7, image: "bg-gradient-to-br from-amber-700 to-amber-900", sizes: ["S (24-28\")", "M (28-32\")", "L (32-36\")", "XL (36-40\")"] },
  { id: 54, name: "Wrist Wraps", category: "Accessories", price: "$15", rating: 4.5, image: "bg-gradient-to-br from-red-500 to-black" },
  { id: 55, name: "Knee Sleeves", category: "Accessories", price: "$40", rating: 4.8, image: "bg-gradient-to-br from-blue-500 to-blue-700", sizes: ["S", "M", "L", "XL"] },
  { id: 56, name: "Lifting Straps", category: "Accessories", price: "$12", rating: 4.6, image: "bg-gradient-to-br from-gray-800 to-black" },
  { id: 57, name: "Chalk Block", category: "Accessories", price: "$8", rating: 4.9, image: "bg-gradient-to-br from-white to-gray-200", sizes: ["Single Block", "8-Pack Box"] },
  { id: 58, name: "Gym Bag Duffle", category: "Accessories", price: "$45", rating: 4.5, image: "bg-gradient-to-br from-indigo-600 to-indigo-900", sizes: ["30L", "45L", "60L"] }, // Volume
  ...
  { id: 63, name: "Weightlifting Shoes", category: "Accessories", price: "$120", rating: 4.7, image: "bg-gradient-to-br from-red-600 to-black", sizes: ["US 7", "US 8", "US 9", "US 10", "US 11", "US 12"] },
  { id: 64, name: "Cross-Training Gloves", category: "Accessories", price: "$25", rating: 4.4, image: "bg-gradient-to-br from-gray-600 to-gray-800", sizes: ["S", "M", "L", "XL"] },
  ...
  { id: 68, name: "Balance Ball", category: "Accessories", price: "$30", rating: 4.5, image: "bg-gradient-to-br from-fuchsia-400 to-fuchsia-600", sizes: ["55cm", "65cm", "75cm"] }, // Diameter
  ...
  { id: 72, name: "Glute Bands", category: "Accessories", price: "$18", rating: 4.7, image: "bg-gradient-to-br from-rose-300 to-rose-500", sizes: ["Light", "Medium", "Heavy"] },
  { id: 73, name: "Suspension Trainer", category: "Accessories", price: "$130", rating: 4.8, image: "bg-gradient-to-br from-yellow-300 to-black" },
  { id: 74, name: "Liquid Chalk", category: "Accessories", price: "$12", rating: 4.6, image: "bg-gradient-to-br from-gray-100 to-gray-300", sizes: ["50ml", "250ml"] },
  ...
  { id: 77, name: "Foam Roller", category: "Recovery", price: "$25", rating: 4.3, image: "bg-gradient-to-br from-pink-500 to-rose-500", sizes: ["18 Inch", "36 Inch"] },
  ...
  { id: 80, name: "Compression Boots", category: "Recovery", price: "$600", rating: 4.9, image: "bg-gradient-to-br from-black to-gray-800", sizes: ["Standard", "Tall"] },
  ...
  { id: 88, name: "Epsom Salts", category: "Recovery", price: "$10", rating: 4.8, image: "bg-gradient-to-br from-white to-gray-100", sizes: ["1kg Bag", "3kg Bag"] },
  { 
    id: 89, 
    name: "Whey Protein", 
    category: "Recovery", 
    ...
    sizes: ["Chocolate (2kg)", "Vanilla (2kg)", "Strawberry (2kg)", "Chocolate (5kg)"] 
  },
  { 
    id: 90, 
    name: "Creatine Mono", 
    ...
    sizes: ["Unflavored (500g)", "Fruit Punch (500g)"] 
  },
  { id: 91, name: "BCAA Powder", category: "Recovery", price: "$30", rating: 4.4, image: "bg-gradient-to-br from-lime-400 to-lime-600", sizes: ["Watermelon (30 servings)", "Blue Razz (30 servings)"] },
  { id: 92, name: "Pre-Workout", category: "Recovery", price: "$45", rating: 4.6, image: "bg-gradient-to-br from-red-600 to-red-800", sizes: ["Grape", "Fruit Punch", "Sour Apple"] },
  { id: 93, name: "Multivitamin", category: "Recovery", price: "$25", rating: 4.5, image: "bg-gradient-to-br from-green-500 to-green-700", sizes: ["60 Caps", "120 Caps"] },
  { id: 94, name: "Sleep Aid", category: "Recovery", price: "$20", rating: 4.3, image: "bg-gradient-to-br from-indigo-800 to-purple-900" },
  { id: 95, name: "Fish Oil", category: "Recovery", price: "$18", rating: 4.5, image: "bg-gradient-to-br from-yellow-300 to-amber-500", sizes: ["1000mg (100ct)", "1000mg (200ct)"] },
  ...
  { id: 99, name: "Kinesiology Tape", category: "Recovery", price: "$15", rating: 4.5, image: "bg-gradient-to-br from-cyan-400 to-blue-500", sizes: ["Black", "Blue", "Beige", "Pink"] },
